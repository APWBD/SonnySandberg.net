...
export default class ReductionView
{
    ...
    build()
    {
        ...
        headline.textContent = "Reduktion";
    ...
    #buildProblem()
    {
        ...
        this.#task = mathExpressionsBuilder.generateReductionTask(1);
...
#buildSteps()
{
    ...
    {
        steps = [
            `Saml alle led, som indeholder x, og saml alle led, som ikke indeholder x.`,
        ];
    }
